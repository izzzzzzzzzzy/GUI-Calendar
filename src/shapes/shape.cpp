...
Shape::Shape(Shader &shader, glm::vec2 pos, glm::vec2 size, color c) : shader(shader), pos(pos), size(size), fill(c) {}

Shape::Shape(Shape const &other) : shader(other.shader), pos(other.pos), size(other.size), fill(other.fill) {}
...
void Shape::setColor(struct color c) { fill = c; }
